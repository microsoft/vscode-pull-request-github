...
import { IAccount, IMilestone, IProjectItem, Issue, reviewerId, reviewerLabel, ReviewState, } from '../../src/github/interface';
...
export default function Sidebar({ reviewers, labels, closingIssues, hasWritePermission, isIssue, projectItems: projects, milestone, assignees, canAssignCopilot }: PullRequest) {
	...
	return (
		<div id="sidebar">
			...
			<Section id="closingIssues" title="Linked Issues" hasWritePermission={false}>
