				...
				return (
					<div>
						...
						<div className="wrapper flex">
							{repoIcon}
							<select
								value={`${params.baseRemote?.owner}/${params.baseRemote?.repositoryName}`}
								onChange={e => {
						...
						<div className="wrapper flex">
							{gitCompareIcon}
							<select value={params.baseBranch} onChange={e => updateBaseBranch(e.currentTarget.value)}>
						...
						<div className="wrapper">
							...
							<div
								id="title-error"
								className={
									params.showTitleValidationError ? 'validation-error below-input-error' : 'hidden'
								}
							>
								A title is required.
							</div>
