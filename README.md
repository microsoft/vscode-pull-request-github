...
> This is a fork the v0.42.0 tag that works withs Github Enterprise
> See [Change Details](https://github.com/jpspringall/vscode-pull-request-github/blob/0.42.1/github-enterprise-authentication-fix/MODIFICATIONS.md).
