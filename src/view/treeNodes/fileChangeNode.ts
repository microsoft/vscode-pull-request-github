...
export class RemoteFileChangeNode extends TreeNode implements vscode.TreeItem {
	...
	constructor(
		...
		this.resourceUri = toResourceUri(vscode.Uri.parse(this.blobUrl), pullRequest.githubNumber, fileName, status);
...
export class FileChangeNode extends TreeNode implements vscode.TreeItem {
	...
	constructor(
		...
		this.resourceUri = toResourceUri(vscode.Uri.file(this.fileName), this.pullRequest.githubNumber, this.fileName, this.status);
	}
	...
	update(comments: IComment[]) {
		...
		DecorationProvider.updateFileComments(this.resourceUri, this.pullRequest.githubNumber, this.fileName, comments.length > 0);
